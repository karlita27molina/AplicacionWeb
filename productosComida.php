...
<body>    
    ...
    <h2 class="texto-centro">Comida</h2>
                            ...
                            while($fila1 = mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <div class="desc-plato-menu">
                                        ...
                                        <input class="btn btn-primary btn-xl" type="image"  name="submit" value="Añadir"  src="assets/imagenes/CartAdd.png" alt="" class="img-pequeño"> 
                                    </div>                          
    ...
    <section class="menu-comidas">
        <div class="contenedor">
            ...
            <?php
                $conn = mysqli_connect(SERVIDOR,USERNAME,PASSWORD,'') or die(mysqli_error());
                $basededatos = mysqli_select_db($conn,BASEDATOS);
                $sql = "Select * from producto where tipo_pro='Comida'";                
                $res = mysqli_query($conn,$sql);
                if ($res == true)
                {
                $numFilas = mysqli_num_rows($res);
    ...
    <?php
                        ...
                        <div class="container px-4 px-lg-5">
                            ...
                            <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                                ...
                                <form id="contactForm" data-sb-form-api-token="API_TOKEN"  method="POST" action="">
                                    ...
                                    <div class=" d-grid">                     
                                        <input class="btn btn-primary btn-xl" type="submit" name="submit"  href="shoppingCart.php" value="Añadir">
                                        </div>  
                                    </form>
                                </div>
                            </div>
        ...
        if(isset($_POST['submit'])){
            ...
            $sqlp = "Select * from producto where tipo_pro='Comida' and id_pro='$pro'";                
