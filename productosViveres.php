...
<body>    
    ...
    <h2 class="texto-centro">Viveres</h2>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="productosComida.php" title="Comida">
                        ...
                        <div class="portfolio-box-caption">
                            ...
                            <div class="Piano Roland clásico">Comida</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
    ...
    <?php
        if(isset($_POST['submits'])){   
            $prod = $_POST['productoBusqueda'];
                $conn = mysqli_connect(SERVIDOR,USERNAME,PASSWORD,'') or die(mysqli_error());
                $basededatos = mysqli_select_db($conn,BASEDATOS);
                $sql = "Select * from producto where tipo_pro='Viveres' and nombre_pro like '%$prod%';";
                $res = mysqli_query($conn,$sql);
                if ($res == true)
                {
                    ?>
                            ...
                            while($fila1 = mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <div class="desc-plato-menu">
                                        <h4><?php echo $nombre1?></h4>
                                        <p class="precio-plato">$ <?php echo $precio1?></p>
                                        <p class="desc-plato"><?php echo $descripcion1?></p>
                                        <br>
                                        <a class="nav-link" href="productosComida.php#limpiar"><input class="btn btn-primary btn-xl" type="image"  name="submits" value="Añadir"  src="assets/imagenes/CartAdd.png" alt="" class="img-pequeño" > </a> 
                                        </div>                          
    ...
    <section class="menu-comidas">
        <div class="contenedor">
            ...
            <?php
                $conn = mysqli_connect(SERVIDOR,USERNAME,PASSWORD,'') or die(mysqli_error());
                $basededatos = mysqli_select_db($conn,BASEDATOS);
                $sql = "Select * from producto where tipo_pro='Viveres'";
                $res = mysqli_query($conn,$sql);
                if ($res == true)
                {
                $numFilas = mysqli_num_rows($res);
    ...
    <?php
        if(isset($_POST['submits'])){   
            $prod = $_POST['productoBusqueda'];
                $conn = mysqli_connect(SERVIDOR,USERNAME,PASSWORD,'') or die(mysqli_error());
                $basededatos = mysqli_select_db($conn,BASEDATOS);
                $sql = "Select * from producto where tipo_pro='Comida' and nombre_pro like '%$prod%';";
                $res = mysqli_query($conn,$sql);
                if ($res == true)
                {
                    ?>
                            ...
                            while($fila1 = mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <div class="desc-plato-menu">
                                        ...
                                        <p class="desc-plato"><?php echo $descripcion1?></p>
                                        <br>
                                        <a class="nav-link" href="productosViveres.php#limpiar"><input class="btn btn-primary btn-xl" type="image"  name="submits" value="Añadir"  src="assets/imagenes/CartAdd.png" alt="" class="img-pequeño" > </a> 
                                        </div>                          
                                <div class="limpiar"></div>
                                </div> 
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sqlp = "Select * from producto where tipo_pro='Viveres' and id_pro='$pro'";                
